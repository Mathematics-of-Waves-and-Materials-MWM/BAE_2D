...
%%%%% Here we assemble the equations for BAE method
%%%%% (Kmat + K^2*Mmat) is the Helmholtz operator
%%%%% 

%%%% Here the stencil for Laplace operator is chosen
...
%%%% this matrix is added to play with embedding. Can be removed
